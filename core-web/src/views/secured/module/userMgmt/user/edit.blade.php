...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('messages_core_web.editUser') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('userInfo.update') }}">
                        ...
                        <input type="hidden" value="{{$user['staff_no']}}" name="staff_no">
                        <input type="hidden" id="activeValue" value="{{$user['active']}}">
                        
                        <div class="form-group row">
                        	<label class="col-sm-2 col-form-label">{{ __('messages_core_web.staffNo') }} *</label>
                        	
                        	<div class="col-sm-2">
                        		<input id="staffIDId" onchange="renderInfoStaff(this);" type="text" class="form-control" name="staff_no"  value="{{$user['staff_no']}}" readonly="readonly">
                        	</div>
                        </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                        	...
                        	<div class="col-sm-4">
                        		<select class="form-control" name="role_id" id="roleId" value="{{$user['role_id']}}">
                        ...
                        <div class="form-group row">
                        	...
                        	<div class="col-sm-4">
                        		<input type="number" id="sessionTimeout" class="form-control col-sm-3" name="session_timeout"  value="{{$user['session_timeout']}}">
                        	</div>
                        	
                        	<label class="col-sm-2 col-form-label">{{ __('messages_core_web.active') }}</label>
                        	
                        	<div class="col-sm-4">
                        		<input type="checkbox" id="activeId" class="form-check-input" name="active">
                        	</div>
                        </div>
                         ...
                         <div class="form-group row">
                        	...
                        	<div class="col-sm-4">
                        		<input type="number" id="maxCountLogin" class="form-control col-sm-3" name="max_count_login"  value="{{$user['max_count_login']}}">
                        	</div>
                        	
                        	<label class="col-sm-2 col-form-label">{{ __('messages_core_web.invalidLoginAttempt') }} *</label>
                        	
                        	<div class="col-sm-4">                        		
                        		<input type="number" id="invalidCountLogin" class="form-control col-sm-3" name="invalid_count_login"  value="{{$user['invalid_count_login']}}">
                        	</div>
                        </div>
